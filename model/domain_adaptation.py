...
# ROI of new samples:
    ...
    data = [
        ("crop124", ([43796, 36356, 76836], [45396, 37956, 78436])),  # !!!
        ("crop125", ([32124, 83300, 60868], [33724, 84900, 62468])),  # !!!
        ("crop131", ([18156, 23300, 23716], [18556, 24900, 25316])),  # !!!
        ("crop132", ([35540, 45724, 26572], [37140, 47324, 28172])), # !!!
        ("crop133", ([34196, 58796, 45596], [35796, 60396, 47196])), # !!!
        ("crop135", ([34620, 39036, 54876], [36220, 40636, 56476])), # !!!
        ("crop136", ([35396, 28060, 36500], [36996, 29660, 38100])),
        ("crop137", ([55996, 33204, 72132], [57596, 34804, 73732])), # !!!
        ("crop138", ([63996, 36796, 51996], [65596, 38396, 53596])), # !!!
        ("crop139", ([36668, 46420, 72996], [37468, 47220, 73796])), # !!!
        ("crop142", ([34804, 41124, 65884], [35604, 41924, 66684])), # !!!
        ("crop143", ([21076, 39620, 51796], [21876, 40420, 52596])), # !!!
        ("crop144", ([40052, 48724, 45636], [40852, 49524, 46436])),
        ("crop145", ([17556, 61748, 46348], [18996, 64748, 49348])), # !!!
        ("crop150", ([34788, 16196, 72996], [35588, 16996, 73796])), # !!!
        ("crop151", ([13572, 41500, 44740], [14372, 42300, 45540])), # !!!
        ("crop157", ([69236, 38196, 23996], [70036, 38996, 24796])), # !!!
        ("crop171", ([35748, 52772, 54244], [37348, 53268, 55844])), # !!!
        ("crop172", ([16308, 57428, 33252], [18308, 59428, 34852])), # !!!
        ("crop175", ([16340, 58020, 36956], [19540, 59220, 39356])), # !!!
        ("crop177", ([6396, 3196, 3196], [12796, 9596, 9596])),      # !!!
        ("crop183", ([69236, 38196, 23996], [70036, 38996, 24796])), # !!!
        ("crop416", ([35748, 52772, 54244], [37348, 53268, 55844])), # !!!
        ("crop417", ([16308, 57428, 33252], [18308, 59428, 34852])), # !!!
    ]

    data1 = [ # Unknown reason why the cops were at different positions
