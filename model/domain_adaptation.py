...
# Name of the model to be used as a base (for two-steps) and the new model
...
unlabeled_folder_path = "/mnt/lustre-emmy-ssd/projects/nim00007/data/mitochondria/files/target_unlabeled"
labeled_folder_path = "/mnt/lustre-emmy-ssd/projects/nim00007/data/mitochondria/files/target_labeled"
# Path to all labeled crops
all_labeled_folder_path = "/mnt/lustre-emmy-ssd/projects/nim00007/data/mitochondria/files/source_labeled"
...
if domain_adaptation_mode == "two-steps":
    ...
    unlabeled_data_paths = directory_to_path_list(unlabeled_folder_path)
    labeled_data_paths = directory_to_path_list(all_labeled_folder_path)
    unlabeled_train_paths, unlabeled_val_paths = train_test_split(unlabeled_data_paths, val_split, random_state = 42)
    labeled_train_paths, labeled_val_paths = train_test_split(labeled_data_paths, val_split, random_state = 42)
else:
